...
public class JmsTopicMessageExtractor {
	private static final Log log = LogFactory.getLog(JmsTopicMessageExtractor.class);
	...
	public static final String ROOT_PATH = "f:/meta/special/";
	...
	JmsTopicMessageExtractor(String cfString, String tString, Environment environment) {
...
//		selector = "EventType = 'OVERLABEL'";
	...
	private String setupDirectory() throws IOException {
		...
		String dirName = ROOT_PATH + sdf.format(new Date()) + "/topic";
	...
	private void process(JmsTopicMessageExtractor extractor) throws IOException {
...
//				}
	...
	public static void main(String[] args) throws IOException {
		JmsTopicMessageExtractor extractor = new JmsTopicMessageExtractor("VS.FDXNET.IPC.CF.WTC",
																		  "D.FDXNET.IPC.EVENT",
																		  Environment.PROD);
